---
title: "Personas API: Personal Profile Management"
sidebarTitle: "Personas"
description: "REST endpoints for creating and managing personal profiles (names, DOB, gender) linked to user accounts in Kantuta POS Backend."
---
