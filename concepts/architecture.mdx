...
description: "Explore how Kantuta POS Backend is organized into NestJS domain modules, how they share services, and how the request lifecycle flows through guards and filters."
---
...
<CardGroup cols={2}>
  ...
  <Card title="GeminiModule / AiAssistantModule" icon="robot">
    Integrates Google Gemini for AI-powered POS assistance — natural-language queries against inventory, sales summaries, and operator guidance.
  </Card>
</CardGroup>
